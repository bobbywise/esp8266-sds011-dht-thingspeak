...
#define DHTPIN D4 
#define DHTTYPE DHT11   // change to DHT22 if you use the DHT22 sensor

const char* ssid     = "Your-Wifi";  // change to your wifi hotspot
const char* password = "Your-Wifi-Password"; // change to your wifi hotspot password
